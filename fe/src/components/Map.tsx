...
export default function Map() {
  ...
  return (
    <MapContainer center={VancouverCenter} zoom={13} scrollWheelZoom={false} style={{ height: "100%", borderRadius: "20px" }}>
      <TileLayer
...
function LocationMarker() {
    ...
    return position === null ? null : (
        <CircleMarker center={position} pathOptions={{ fillColor: "blue", color: "" }} radius={100}>
